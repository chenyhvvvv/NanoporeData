...
class ExperiMan(object):
    ...
    def get_basic_arg_parser(self):
        ...
        parser.add_argument('--data_dir', type=str, default="/import/home2/yhchenmath/Dataset/ONT", help="data dir")
        # ======> Setting run_dir
        parser.add_argument('--log_dir', type=str, default="/import/home2/yhchenmath/Log/NanoporeData", help="root dir for logging")
        parser.add_argument('--exp_name', type=str, default="UNDEFINED", help="name of the experiment")
